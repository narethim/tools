...
#
# sudo tc qdisc add dev eth0 root handle 1: tbf rate 128kbit burst 1600 limit 3000
...
tc qdisc add dev eth0 root handle 1: tbf rate 128kbit burst 1600 limit 3000
